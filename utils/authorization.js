...
import { publicKey, privateKey } from '../config/constants.js'
...
const ADDRESS = process.env.NEXT_PUBLIC_FLOWNS_ADDRESS

export const authorizationFunctionProposer = async (account) => {
  let keyId = 0
...
export const getScript = async (name, type = 'transcation') => {
  try {
